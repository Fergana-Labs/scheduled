...
It's expense report season. You know what that means: **hunting through months of emails** looking for receipts.

Uber rides. Amazon purchases. Hotel confirmations. Software subscriptions. They're all buried somewhere in your inbox, but good luck finding them efficiently.

You'll spend hours:

- Searching "receipt" and getting 10,000 irrelevant results
- Trying different sender names (was it "Uber Receipts" or "Uber"?)
- Downloading PDFs one at a time
...
The average person gets dozens of receipts via email every month:
...
- Service invoices (contractors, freelancers)

These emails are scattered across months or years of inbox history. They have different formats, subject lines, and senders. And you need to find **all of them** for:
...
- All Amazon orders
- All hotel and flight confirmations
- All subscription payments
- Any other purchase confirmations
...
- **Creates a summary report** with totals by category
- **Exports everything** as a folder of PDFs, a CSV for accounting, or a summary doc

Ready to submit for reimbursement or hand to your accountant.

## Real Example: Quarterly Expense Report

Let's say you're a consultant who needs to submit quarterly expense reports.

**Old manual way:**

1. Search inbox for "receipt" → 5,000 results
2. Search for individual services → "Uber", "Amazon", "Delta", etc.
3. Open each email, download PDF attachments
4. Create folders and organize by category
5. Manually sum up totals
6. Create expense report spreadsheet
7. Attach all PDFs
...
3. Export as categorized folder + expense summary
...
This workflow is valuable for anyone who needs to track expenses:

**For Employees:**

- Monthly expense reimbursement requests
- Travel expense reports after business trips
- Annual company card reconciliation

**For Freelancers/Contractors:**

- Client reimbursable expenses
- Tax deduction documentation
- Invoice backup and record-keeping

**For Business Owners:**

- Monthly accounting reconciliation
- Tax preparation (Schedule C, etc.)
...
Think about how often you need receipts:

- Monthly expense reports: **Save 2 hours/month** = 24 hours/year
- Quarterly tax prep: **Save 3 hours/quarter** = 12 hours/year
- Annual tax filing: **Save 5 hours** = 5 hours/year
- Ad-hoc receipt lookups: **Save 1 hour/month** = 12 hours/year

**Total time saved: 50+ hours per year** you'd otherwise spend hunting through emails.
...
The next time someone asks for receipts, you'll have them ready in minutes instead of dreading hours of email archaeology.
