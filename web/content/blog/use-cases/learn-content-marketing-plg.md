...
1. **Collect resources** → Bookmark 100+ articles, save videos
2. **Consume sporadically** → Read when you have time (half-focused, usually)
3. **Take scattered notes** → In margins, different apps, or not at all
4. **Forget most of it** → Can't recall specifics when you actually need them
5. **Repeat the cycle** → Keep collecting more content without deeper understanding
