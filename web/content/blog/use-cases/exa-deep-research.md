...
1. **Google search** → Open 15 tabs that look relevant
2. **Skim articles** → Bookmark the good ones (maybe)
3. **Take scattered notes** → In three different apps because you forgot where you started
4. **Try to synthesize** → Stare at notes wondering how they all fit together
5. **Give up** → Either write something half-baked or abandon the project
...
**Time invested:** 20 minutes framing questions and reviewing output
**What you got:** A comprehensive research brief that would've taken 4+ hours manually
