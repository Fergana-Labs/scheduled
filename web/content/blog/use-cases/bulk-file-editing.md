...
Add dates, project codes, version numbers automatically

**Content-based sorting:**
Organize by topic, client, project phase based on what's actually in the file

**Conditional processing:**
"Convert to PDF only if file is newer than June 2025"
"Rename client files differently than internal docs"

**Quality control:**
"Flag any files that don't match the expected format"
"Show me files that might have errors"
